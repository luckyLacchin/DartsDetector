...
class TrackerDarts:
    ...
    def draw_annotations(self, video_frames, tracks):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for dart in linked_darts_dic.values():
                frame = self.draw_dart_rectangle(frame, dart["bbox"],(0,0,255))
                
                
            #Draw board
            for track_id, board in board_dict.items():
                frame = self.draw_dart_rectangle(frame, board["bbox"],(0,255,0))
    ...
    def draw_dart_rectangle(self, frame, bbox, color=(255, 255, 0)):
        """
